...
describe('read ttf buffer', function () {
    let font = createFont(readData('baiduHealth.ttf'), {
        type: 'ttf'
    });
...
describe('read otf buffer', function () {
    let font = createFont(readData('BalladeContour.otf'), {
        type: 'otf'
    });
...
describe('read woff buffer', function () {
    let buffer = createFont(readData('baiduHealth.ttf'), {
        type: 'ttf'
    }).write({
        type: 'woff'
    });
...
describe('read svg text', function () {
    let font = createFont(readData('iconfont-xin.svg'), {
        type: 'svg'
    });
...
describe('read svg font text', function () {
    let font = createFont(readData('icomoon.svg'), {
        type: 'svg'
    });
...
describe('write ttf buffer', function () {
    ...
    it('test write ttf hinting', function () {
        let buffer = createFont(readData('baiduHealth-hinting.ttf'), {
            type: 'ttf',
            hinting: true
        }).write({
            hinting: true
...
describe('toBase64', function () {
    ...
    it('test ttf to toBase64', function () {
        let base64Str = createFont(readData('baiduHealth.ttf'), {
            type: 'ttf'
        }).toBase64({
            type: 'ttf'
        });
...
describe('font method', function () {
    ...
    it('merge', function () {
        ...
        let font1 = createFont(readData('icomoon.svg'), {
            type: 'svg'
        });
        font1.optimize();
        assert.equal(font.data.glyf.length, 17);
